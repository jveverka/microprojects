...
public class EventLoggerServiceImpl implements EventLoggerService {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(EventLoggerServiceImpl.class);

    private final ElasticsearchOperations elasticsearchOperations;
    private final ElasticConfig elasticConfig;

    @Autowired
    public EventLoggerServiceImpl(ElasticsearchOperations elasticsearchOperations, ElasticConfig elasticConfig) {
    ...
    public IdDTO save(String userId, EventDTO eventDTO) {
        ...
        IndexQuery indexQuery = new IndexQueryBuilder()
                ...
                .build();
        String documentId = elasticsearchOperations.index(indexQuery, IndexCoordinates.of(elasticConfig.index()));
    ...
    public List<EventDocument> getAll() {
        ...
        SearchHits<EventDocument> events = elasticsearchOperations
                .search(Query.findAll(), EventDocument.class, IndexCoordinates.of(elasticConfig.index()));
